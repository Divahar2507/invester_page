...
const Sidebar = () => {
    ...
    const [navItems, setNavItems] = React.useState(NAV_ITEMS); // Default to investor
        ...
        <div className="w-64 bg-white border-r border-slate-200 h-screen flex flex-col sticky top-0">
            <div className="p-6">
                <div className="flex items-center gap-2 mb-8">
                    ...
                    <span className="text-xl font-bold text-slate-900 tracking-tight">PitchDeck AI</span>
                </div>
